# Állapot — 2026-08-26 (frissítve: BESZÉLHETŐ KIMENETI MÓD és
ASR-hibatűrés — az M6 hangcsatorna szövegoldali előkészítése; a
válaszidő-elvárás ELOSZLÁS lett (ADR-022: p50 < 10 s, p95 < 25 s,
tendencia); KÉT ÚJABB MÉRÉSI HIBA javítva)

**A kör két legfontosabb mondata:**
...
`python feladat.py vegigjatszas --robusztus --mod mindketto` — 13 saját
...
| | szöveges | beszélhető |
|---|---|---|
| eset | 63 (+13 beszélgetés + foglalási menet) | ugyanaz |
| **kivétel** | **0** | **0** |
...
KETTŐT, mindkettő a beszélhető módban:
